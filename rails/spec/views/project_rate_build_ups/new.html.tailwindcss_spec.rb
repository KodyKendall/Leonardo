...
RSpec.describe "project_rate_build_ups/new", type: :view do
  before(:each) do
    assign(:project_rate_build_up, ProjectRateBuildUp.new(
      tender: nil,
  ...
  it "renders new project_rate_build_up form" do
    render

    assert_select "form[action=?][method=?]", project_rate_build_ups_path, "post" do
