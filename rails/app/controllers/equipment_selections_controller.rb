    ...
    respond_to do |format|
      if @equipment_selection.save
        format.turbo_stream do
          render turbo_stream: [
            turbo_stream.append("equipment_selections_table", partial: "equipment_selections/equipment_selection", locals: { equipment_selection: @equipment_selection }),
            turbo_stream.update("new_equipment_form", partial: "equipment_selections/add_form", locals: { tender: @tender, new_equipment_selection: TenderEquipmentSelection.new(tender: @tender), equipment_types: @equipment_types })
          ]
        end
        format.html { redirect_to tender_equipment_selections_path(@tender), notice: "Equipment selection was successfully created." }
      else
        format.turbo_stream do
          render turbo_stream: turbo_stream.update("new_equipment_form", partial: "equipment_selections/add_form", locals: { tender: @tender, new_equipment_selection: @equipment_selection, equipment_types: @equipment_types })
        end
